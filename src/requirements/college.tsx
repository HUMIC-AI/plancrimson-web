...
const genedRequirement = (targetType: NonNullable<Class['IS_SCL_DESCR100_HU_SCL_ATTR_GE']>): Requirement => ({
  id: targetType,
  sourcePage: 12,
...
const divisionalDistribution = (targetType: NonNullable<Class['IS_SCL_DESCR100_HU_SCL_ATTR_LDD']>): Requirement => ({
  id: targetType,
  sourcePage: 58,
  validate: (count) => count > 0,
  reducer: (prev, cls) => {
...
const genedRequirements: RequirementGroup = {
  ...
  description: (
    <div className="space-y-2">
      <p>
        Students graduating in May 2020 or later must complete four General Education courses, one from each of the following four General Education categories:
      </p>
      ...
      <p>
        ...
        website (
        <ExternalLink href="https://gened.fas.harvard.edu/">https://gened.fas.harvard.edu/</ExternalLink>
        ), or contact the General Education Office
        (617-495-2563, Smith Campus Center, Fourth Floor,
        {' '}
        <ExternalLink href="mailto:gened_questions@fas.harvard.edu">gened_questions@fas.harvard.edu</ExternalLink>
        ).
      </p>
    </div>
  ),
  ...
  description: (
    <div className="space-y-2">
      ...
      <p>
        ...
        {' '}
        <ExternalLink href="mailto:divdist@fas.harvard.edu">divdist@fas.harvard.edu</ExternalLink>
        .
      </p>
    </div>
  ),
...
const qrdRequirement: RequirementGroup = {
  groupId: 'Quantitative Reasoning with Data requirement',
  description: (
    <div className="space-y-2">
      <p>
      ...
      <p>
        ...
        {' '}
        <ExternalLink href="https://oue.fas.harvard.edu/files/oue/files/courses_previously_approved_for_emr.pdf">https://oue.fas.harvard.edu/files/oue/files/courses_previously_approved_for_emr.pdf</ExternalLink>
        .
      </p>
      <p>
      ...
      <p>
        ...
        {' '}
        <ExternalLink href="mailto:QRD@fas.harvard.edu">QRD@fas.harvard.edu</ExternalLink>
        .
      </p>
    </div>
  ),
...
const exposRequirement: RequirementGroup = {
  groupId: 'Expository Writing',
  sourcePage: 14,
  description: (
    <div className="space-y-2">
      <p>
      ...
      <p>
        ...
        Program at 617-495-2566 or
        {' '}
        <ExternalLink href="mailto:expos@fas.harvard.edu">expos@fas.harvard.edu</ExternalLink>
        {' '}
  ...
  requirements: [
    {
      ...
      reducer: (prev, cls, schedule) => {
        if (cls.CRSE_ID === '116353') {
          const grade = schedule.classes.find(({ classId }) => classId === getClassId(cls))?.grade;
...
const languageRequirement: RequirementGroup = {
  groupId: 'Language requirement',
  sourcePage: 14,
  description: (
    <div className="space-y-2">
      <p>
      ...
      <ul>
        ...
        <li>
          Passing with a letter grade one appropriate year-long course (8 credits) or two
          semesterlong courses (4 credits each) in one language at Harvard, or the equivalent as
      ...
      <p>
        ...
        and FAQs, can be found on the Placement Exams Information website, at
        {' '}
        <ExternalLink href="https://placementinfo.fas.harvard.edu/home">https://placementinfo.fas.harvard.edu/home</ExternalLink>
        .
      </p>
      <p>
      ...
      <p>
        ...
        {' '}
        <ExternalLink href="https://handbook.college.harvard.edu/#fields">https://handbook.college.harvard.edu/#fields</ExternalLink>
        ).
      </p>
    </div>
  ),
