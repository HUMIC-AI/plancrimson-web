  ...
  requirements: [
    {
      ...
      description: 'Either MATH MA, MB, and 1B, or MATH 1A and 1B. Students may place out of some or all of this requirement depending on their starting Mathematics course.',
      sourcePage: 56,
      reducer: (prev, cls) => {
        if ([
          'MATH MA',
          ...
          'MATH 1A',
          'MATH 1B',
        ].includes(cls.SUBJECT + cls.CATALOG_NBR)) {
          return prev + 1;
        }
        return null;
      },
    ...
    {
      id: 'Linear algebra',
      description: 'One course in linear algebra. Satisfied by APMTH 22A, MATH 21B, MATH 22A, MATH 23A, MATH 25A, MATH 55A, or a more advanced course.',
      sourcePage: 57,
      ...countTag('linearalgebra'),
    },
    {
      id: 'Probability',
      description: 'One course in probability. Satisfied by STAT 110, ENG-SCI 150, MATH 154, or a more advanced course.',
      sourcePage: 57,
...
export const csCore: RequirementGroup = {
  ...
  requirements: [
    ...
    requirements.computationAndTheWorld,
    {
      ...
      description: 'Four sufficiently advanced Computer Science courses, roughly corresponding to all CS courses numbered 100 and above. (See the concentration website for the full list.)',
      sourcePage: 57,
