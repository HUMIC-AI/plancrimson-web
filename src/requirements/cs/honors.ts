import { Requirement, RequirementGroup, SampleSchedule } from '../util';
...
import sampleSchedules from './sample/honors.json';

const formalReasoning: RequirementGroup = {
  groupId: 'Formal Reasoning tag',
  subheading: '3 courses in the Computer Science core',
  description:
    'Same as Basic Requirements, but requiring Intermediate Algorithms rather than Algorithms, as follows',
  sourcePage: 58,
  requirements: [
    ...
    requirements.computationalLimitations,
    {
      ...
      description:
        'One course covering basic and intermediate topics in algorithms. Replaces the Algorithms tag from the Basic Requirements.',
      sourcePage: 59,
...
const csCore: RequirementGroup = {
  ...
  description:
    'Eleven courses from an approved list on the concentration’s website. This is the same list as for the basic requirements, but two more courses are required. These courses, taken together, must satisfy the following tag requirements.',
  sourcePage: 58,
  requirements: [
    ...
    requirements.computationAndTheWorld,
    {
      ...
      description:
        'One course covering topics in artificial intelligence. (Most such courses will simultaneously satisfy the Computation and the World tag.)',
      sourcePage: 59,
      ...countTag('ai'),
    },
    {
      ...
      description:
        'Five sufficiently advanced Computer Science courses (one more than in the Basic Requirements).',
      sourcePage: 59,
...
const requiredCourses: RequirementGroup = {
  ...
  description:
    'A student’s Plan of Study must satisfy each of the requirements below. Courses are allowed to satisfy multiple requirements, but a student’s Plan of Study must still comprise thirteen to sixteen courses in total.',
  sourcePage: 58,
  requirements: [mathematicalPreparation, csCore],
};
