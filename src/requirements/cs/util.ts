...
export function countTag(
  tag: CSCourseTag,
  required = 1,
): Pick<Requirement, 'reducer' | 'validate'> {
  return {
...
export const generateAdvancedCs = (
  numCourses: number,
  numberTitle: string,
  sourcePage: number,
) => ({
...
export const requirements = {
  discreteMath: {
    ...
    description:
      'One course with significant discrete math content. Students may skip this requirement with approval from the Directors of Undergraduate Studies; see the Computer Science website for more information.',
    sourcePage: 57,
  ...
  systems: {
    ...
    description:
      'One course containing significant computer system development.',
    sourcePage: 57,
    ...countTag('systems'),
  },
  computationAndTheWorld: {
    ...
    description:
      'One course on interactions between computation and the world (for example, concerning informational, natural, human, or social systems).',
    sourcePage: 57,
  ...
  tutorial: {
    id: 'Tutorial',
    description:
      'Optional. Available as COMPSCI 91R. This course is repeatable, but may be taken at most twice for academic credit, and only one semester of COMPSCI 91R may be counted toward concentration requirements as a Computer Science core course. Students wishing to enroll in COMPSCI 91R must file a project proposal to be signed by the student and the faculty supervisor and approved by the Directors of Undergraduate Studies. The project proposal form can be found on the Computer Science website.',
    sourcePage: 57,
...
export const otherInformation = {
  ...
  requirements: [
    ...
    },
    {
      ...
      description:
        'No more than two of the courses used to satisfy CS Requirements may be taken pass/fail or SAT/UNSAT. Of the tag requirements, courses taken pass/fail or SAT/UNSAT can be used only for the Programming 1 and Advanced Computer Science tags. For instance, if taken pass/fail, COMPSCI 124 would not satisfy the Formal Reasoning or Algorithms tags.',
      sourcePage: 58,
      ...descriptionOnly(),
    },
    {
      ...
      description:
        'Except for MATH MA, MATH MB/1A, and MATH 1B, there is no reduction in concentration requirements for prior work',
      sourcePage: 58,
      ...descriptionOnly(),
    },
    {
